...
### Una imagen contenida como archivo

Ademas, podemos anexar archivos contenidos en nuestra computadora:


```{r Imagen}
knitr::include_graphics("figures/dplyr_joins.png")
```
...
## 13. Configuración de los Chunks
